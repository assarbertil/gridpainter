...
export function SavedGames() {
  ...
  return (
    <div className="max-w-[60rem] flex flex-col justify-center m-20 mx-auto">
      ...
      <h1 className="py-8 text-xl font-medium text-center max-w-[60rem] mx-auto">Facit</h1>
          ...
          imageData.map((image) => (
            <div key={image._id}>
              ...
              <div className="space-x-1 text-xs">
                {image.percentCorrect > 0 && <FontAwesomeIcon icon="fa-solid fa-star" className="text-amber-500" />}
                {image.percentCorrect >= 20 && <FontAwesomeIcon icon="fa-solid fa-star" className="text-amber-500" />}
                {image.percentCorrect >= 40 && <FontAwesomeIcon icon="fa-solid fa-star" className="text-amber-500" />}
                {image.percentCorrect >= 60 && <FontAwesomeIcon icon="fa-solid fa-star" className="text-amber-500" />}
                {image.percentCorrect >= 80 && <FontAwesomeIcon icon="fa-solid fa-star" className="text-amber-500" />}
              </div>
